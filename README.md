# 区块链收藏游戏：僵尸之谜
[![Build Status](https://travis-ci.org/one1s/zombie-game21.svg?branch=master)](https://travis-ci.org/one1s/zombie-game21)
## Demo
https://one1s.github.io/zombie-game21/ <br />
...
- 项目中已经在[这个文件](https://github.com/one1s/my-crypto-zombie/blob/master/src/ContractAddress.json)中设置好了智能合约的地址,你也可以修改成你自己部署的智能合约合约地址
...
本项目所使用的[智能合约源码在这里](https://github.com/one1s/smart-contract/tree/master/Solidity%20Lesson%2004)<br>
